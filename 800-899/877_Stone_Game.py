...
class Solution:
    def stoneGame(self, piles: List[int]) -> bool:
        # При 2х стопках. Победа очевидна.
        # При 4х стопках [a, b, c, d] если выбрать a, то на следующем ходу всегда можно выбрать c. И наоборот при выборе
        # d всегда есть возможность вторым своим ходом взять b.
        # Аналогично для любого числа стопок. Т.О. если сумма камней в четных стопках больше то брать всегда четные
        # стопки и наоборот.
        return True
